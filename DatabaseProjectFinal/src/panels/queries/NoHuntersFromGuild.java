 ...
 * @author Zuhair
 */
public class NoHuntersFromGuild extends javax.swing.JPanel
{
    DatabaseConnector dbCon;
    ResultSet rs;

    /**
     * Creates new form NoHuntersFromGuild
     */
    public NoHuntersFromGuild()
    {
        initComponents();
        try
        {
            ...
            rs = dbCon.executeStatement("SELECT guildid FROM guild ORDER BY guildid ASC");
            jComboBox1.removeAllItems();
            while(rs.next())
            {
                jComboBox1.addItem(rs.getString("guildid"));
            }
            rs = dbCon.executeStatement("select H.guildid, count(*) AS \"number\" FROM Hunter H WHERE H.guildid= " + jComboBox1.getSelectedItem().toString() + " group by H.guildid");
            rs.first();
        ...
        } catch(SQLException e)
        {
            ...
            System.out.println("Update 1 error");
        }
    }
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("Search Number of Hunters by Guild");
        ...
        jLabel4.setText("Number of Hunters in Guild:");
